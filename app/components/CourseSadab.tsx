      ...
      {course.map((course) => (
        <div key={course.id}>
          ...
          >
            ...
            {/* 2 */}
            <div>
              <p className="text-white">Created by {course.author}</p>
            </div>
            {/* 3 */}
                ...
                <div tabIndex={0} className="collapse collapse-arrow border ">
                  ...
                  <div className="collapse-content font-medium">
                    <p className="text-justify">
                      ...
                      Provident quisquam, <br /> necessitatibus sunt voluptas
                      optio iusto esse tenetur laborum est pariatur <br /> autem
                      ipsa nihil, aperiam sit, maxime doloremque labore? Earum,
                      iste.
                    </p>
                  </div>
                </div>
