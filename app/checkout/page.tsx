...
import dpro1 from '../../public/assets/dpro1.png'
import dpro2 from '../../public/assets/dpro2.png'
...
function page() {
  return (
    <div>
      ...
      {/* secure payment section start  */}

      <div className="container p-12 mx-auto">
            <div className="flex flex-row gap-20  w-full px-0 mx-auto md:flex-row">
                <div className="flex flex-col  md:w-full">
                    ...
                    <form className="justify-center w-full mx-auto" method="post" >
                        <div className="">
                            ...
                            <div className="mt-4">
                                <button
                                    className="w-full px-6 py-2 text-blue-200 bg-blue-600 hover:bg-blue-900">Confirm Payment</button>
                            </div>
                        </div>
                    </form>
                </div>
